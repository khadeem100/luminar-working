      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl font-bold text-gray-800 mb-4">Luminar Learning</h1>
            <p className="text-xl text-gray-600">Choose a language to start learning!</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {languages.map((language) => (
                ...
                >
                  ...
                  <p className="text-gray-500 text-sm uppercase tracking-wide">{language.code}</p>
                </button>
              ))}
            </div>
          )}
          ...
          {!loading && languages.length === 0 && (
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              <p className="text-gray-600 mb-4">No languages found. Please add languages in Directus.</p>
              <a
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-gray-800">{selectedLanguage.name}</h2>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <h3 className="text-5xl font-bold text-indigo-600 mb-8">{currentWord.word}</h3>
            </div>
